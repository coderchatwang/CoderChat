...
export const displayInfoOfProviderName = (providerName: ProviderName): DisplayInfoForProviderName => {
	if (providerName === 'anthropic') {
		...
		return { title: 'OpenAI-Compatible-4', }
	}
	else if (providerName === 'openAICompatible5') {
		return { title: 'OpenAI-Compatible-5', }
	}
	else if (providerName === 'openAICompatible6') {
		return { title: 'OpenAI-Compatible-6', }
	}
	else if (providerName === 'openAICompatible7') {
		return { title: 'OpenAI-Compatible-7', }
	}
	else if (providerName === 'openAICompatible8') {
		return { title: 'OpenAI-Compatible-8', }
	}
	else if (providerName === 'openAICompatible9') {
		return { title: 'OpenAI-Compatible-9', }
	}
...
export const subTextMdOfProviderName = (providerName: ProviderName): string => {
	...
	if (providerName === 'openAICompatible2') return `Use any provider that's OpenAI-compatible (use this for llama.cpp and more).`
	if (providerName === 'openAICompatible3') return `Use any provider that's OpenAI-compatible (use this for llama.cpp and more).`
	if (providerName === 'openAICompatible4') return `Use any provider that's OpenAI-compatible (use this for llama.cpp and more).`
	if (providerName === 'openAICompatible5') return `Use any provider that's OpenAI-compatible (use this for llama.cpp and more).`
	if (providerName === 'openAICompatible6') return `Use any provider that's OpenAI-compatible (use this for llama.cpp and more).`
	if (providerName === 'openAICompatible7') return `Use any provider that's OpenAI-compatible (use this for llama.cpp and more).`
	if (providerName === 'openAICompatible8') return `Use any provider that's OpenAI-compatible (use this for llama.cpp and more).`
	if (providerName === 'openAICompatible9') return `Use any provider that's OpenAI-compatible (use this for llama.cpp and more).`
	if (providerName === 'googleVertex') return 'You must authenticate before using Vertex with CoderChat. Read more about endpoints [here](https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/call-vertex-using-openai-library), and regions [here](https://cloud.google.com/vertex-ai/docs/general/locations#available-regions).'
									...
									providerName === 'openAICompatible' ? 'sk-key...' :
										providerName === 'openAICompatible2' ? 'sk-key...' :
											providerName === 'openAICompatible3' ? 'sk-key...' :
												providerName === 'openAICompatible4' ? 'sk-key...' :
													providerName === 'openAICompatible5' ? 'sk-key...' :
														providerName === 'openAICompatible6' ? 'sk-key...' :
															providerName === 'openAICompatible7' ? 'sk-key...' :
																providerName === 'openAICompatible8' ? 'sk-key...' :
																	providerName === 'openAICompatible9' ? 'sk-key...' :
					...
					: providerName === 'openAICompatible' ? 'https://my-website.com/v1'
						: providerName === 'openAICompatible2' ? 'https://my-website.com/v1'
							: providerName === 'openAICompatible3' ? 'https://my-website.com/v1'
								: providerName === 'openAICompatible4' ? 'https://my-website.com/v1'
									: providerName === 'openAICompatible5' ? 'https://my-website.com/v1'
										: providerName === 'openAICompatible6' ? 'https://my-website.com/v1'
											: providerName === 'openAICompatible7' ? 'https://my-website.com/v1'
												: providerName === 'openAICompatible8' ? 'https://my-website.com/v1'
													: providerName === 'openAICompatible9' ? 'https://my-website.com/v1'
...
export const defaultSettingsOfProvider: SettingsOfProvider = {
	...
	openAICompatible6: { // aggregator (serves models from multiple providers)
		...defaultCustomSettings,
		...defaultProviderSettings.openAICompatible6,
		...modelInfoOfDefaultModelNames(defaultModelsOfProvider.openAICompatible6),
		_didFillInProviderSettings: undefined,
	},
	openAICompatible7: { // aggregator (serves models from multiple providers)
		...defaultCustomSettings,
		...defaultProviderSettings.openAICompatible7,
		...modelInfoOfDefaultModelNames(defaultModelsOfProvider.openAICompatible7),
		_didFillInProviderSettings: undefined,
	},
	openAICompatible8: { // aggregator (serves models from multiple providers)
		...defaultCustomSettings,
		...defaultProviderSettings.openAICompatible8,
		...modelInfoOfDefaultModelNames(defaultModelsOfProvider.openAICompatible8),
		_didFillInProviderSettings: undefined,
	},
	openAICompatible9: { // aggregator (serves models from multiple providers)
		...defaultCustomSettings,
		...defaultProviderSettings.openAICompatible9,
		...modelInfoOfDefaultModelNames(defaultModelsOfProvider.openAICompatible9),
		_didFillInProviderSettings: undefined,
	},
