	...
	registry.registerConfiguration({
		...
		'properties': {
			...
			'workbench.sideBar.location': {
				...
				'enum': ['left', 'right'],
				'default': 'left',
				'description': localize('sideBarLocation', "Controls the location of the primary side bar and activity bar. They can either show on the left or right of the workbench. The CoderChat side bar will show on the opposite side of the workbench.")
			},
			...
			[LayoutSettings.ACTIVITY_BAR_LOCATION]: {
				...
				'default': 'default',
				'markdownDescription': localize({ comment: ['This is the description for a setting'], key: 'activityBarLocation' }, "Controls the location of the Activity Bar relative to the Primary and CoderChat Side Bars."), // CoderChat side bar
				'enumDescriptions': [
					localize('workbench.activityBar.location.default', "Show the Activity Bar on the side of the Primary Side Bar and on top of the CoderChat Side Bar."), // CoderChat side bar
					localize('workbench.activityBar.location.top', "Show the Activity Bar on top of the Primary and CoderChat Side Bars."), // CoderChat side bar
					localize('workbench.activityBar.location.bottom', "Show the Activity Bar at the bottom of the Primary and CoderChat Side Bars."), // CoderChat side bar
					localize('workbench.activityBar.location.hide', "Hide the Activity Bar in the Primary and CoderChat Side Bars.") // CoderChat side bar
				],
			},
	...
	registry.registerConfiguration({
		...
		'properties': {
			...
			'window.confirmBeforeClose': {
				...
				'default': (isWeb && !isStandalone()) ? 'keyboardOnly' : (isWindows ? 'always' : 'never'), // on by default in web, unless PWA, always on Windows desktop to prevent accidental close, never on macOS/Linux desktop
				'markdownDescription': isWeb ?
