...
在你的代码库上使用 AI 智能体，并可视化变更，并将任何模型或主机带到本地。**目前为止，即使用户使用自定义模型，主流商业付费/免费AI编辑器几乎都是将提示词组装逻辑在服务器中实现，也就是说代码等用户数据在工具厂商处经过了二次中转，毫无保密和隐私可言**，CoderChat 直接向模型服务提供商发送消息，不会保留和查看你的代码数据。这也是CoderChat相较于功能完善的商业项目存在的价值之一。
...
| 平台 |  下载链接 (1.5.0)|  备注 |
|----------|---------------|---------------|
| macOS (Apple Silicon) | [CoderChat-darwin-arm64.dmg](https://github.com/coderchatwang/CoderChat/releases/download/1.5.0/CoderChat-darwin-arm64.dmg)  | 未签名，若安装被拦截需信任后打开|
| macOS (Intel) | [CoderChat-darwin-x64.dmg](https://github.com/coderchatwang/CoderChat/releases/download/1.5.0/CoderChat-darwin-x64.dmg) |未签名，若安装被拦截需信任后打开|
| Windows (x64) |[CoderChatSetup-x64-system.exe](https://github.com/coderchatwang/CoderChat/releases/download/1.5.0/CoderChatSetup-x64-system.exe)  <br> [CoderChatSetup-x64-user.exe](https://github.com/coderchatwang/CoderChat/releases/download/1.5.0/CoderChatSetup-x64-user.exe)  |未签名，若拦截为系统默认行为|
| Windows (ARM64) |[CoderChatSetup-arm64-system.exe](https://github.com/coderchatwang/CoderChat/releases/download/1.5.0/CoderChatSetup-arm64-system.exe)  <br>  [CoderChatSetup-arm64-user.exe](https://github.com/coderchatwang/CoderChat/releases/download/1.5.0/CoderChatSetup-arm64-user.exe) |未签名，若拦截为系统默认行为|
